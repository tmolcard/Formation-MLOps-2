...
app = Flask(__name__)
model = joblib.load('20200616-140746.joblib')
...
def predict_endpoint():
    ...
    received_data_df = pd.DataFrame({
        ...
        "Yt_max": 20.79, "Yt_std": 0.07, "Ws1_avg": received_wind_speed_avg, "Ws1_min": 0.0, "Ws1_max": 1.94, "Ws1_std": 0.44,
    ...
    df_features = prepare_features(received_data_df)
    result = predict(features=df_features, model_path='20200616-140746.joblib')
    jsonify(result)
